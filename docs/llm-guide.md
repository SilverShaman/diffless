...
2. **Sequential Thinking**: Phase 5 (Artifact-Driven PRs) is exclusively implemented. Agents running in this CLI must now move sequentially toward Phase 6 (Natural Language Execution Schema generation). Semantic Merging).
